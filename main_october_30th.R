...
# writeLines(all_degs, "2025.10.28.in_vitro_degs.dp100_padj01_logROR01.txt")
# writeLines(missense_tfs, "2025.10.28.in_vitro_missenses.dp100_padj01_logROR01.txt")
...
write_tsv(uniprot_with_domains %>% select(symbol, rsid, Domain), "missense_snps_uniprot_annotation.tsv")
...
write_tsv(go_degs, "2025.10.28.GO_degs.tsv")
write_tsv(kegg_degs, "2025.10.28.KEGG_degs.tsv")
# write_tsv(go_missenses, "2025.10.28.GO_missenses.tsv")
write_tsv(kegg_missenses, "2025.10.28.KEGG_missenses.tsv")
write_tsv(go_ddase, "2025.10.28.GO_ddASE_genes.tsv")
# write_tsv(kegg_ddase, "2025.10.28.KEGG_ddASE_genes.tsv")
